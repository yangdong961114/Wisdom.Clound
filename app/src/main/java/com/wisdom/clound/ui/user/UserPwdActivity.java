...
public class UserPwdActivity extends AppCompatActivity {
    ...
    private static final String URL_UPDATE_USER_INFO = "https://api.rzkj.qyqd123.cn/Android/MineFragment/UserPwdEdit";
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    try {
                        ...
                        if (code == 200) {
                            ...
                            // 获取解密后的原密码
                            originalPwd = dataObj.getString("UserLoginPwdDecrypt");
                        } else {
    ...
    private void jumpToMineFragment() {
        Intent intent = new Intent(UserPwdActivity.this, com.wisdom.clound.MainActivity.class);
